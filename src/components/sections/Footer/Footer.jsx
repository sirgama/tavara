    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <Image
        ...
        <div class="flex mt-8 space-x-6 text-gray-100">
          ...
          <a class="hover:opacity-75" href="https://www.instagram.com/cojanitoursandtravel/profilecard/?igsh=d2twZGE0OXE2ZWR1" rel="noreferrer">
          ...
          <a class="hover:opacity-75" href="https://x.com/and_cojani?t=GQtzlC0lfXf8LIYWrQecKA&s=09" rel="noreferrer">
      ...
      <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-100">
            <Link class="hover:opacity-75" href='/about'> About cojani </Link>
