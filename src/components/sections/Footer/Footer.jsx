    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <Image
        ...
        <div class="flex mt-8 space-x-6 text-gray-100">
          <a class="hover:opacity-75" href target="https://www.facebook.com/profile.php?id=100067907509912&mibextid=ZbWKwL" rel="noreferrer">
            <span class="sr-only"> Facebook </span>
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
            </svg>
          </a>
          <a class="hover:opacity-75" href target="https://www.instagram.com/tavaratoursandtravel/profilecard/?igsh=d2twZGE0OXE2ZWR1" rel="noreferrer">
          ...
          <a class="hover:opacity-75" href target="https://x.com/and_tavara?t=GQtzlC0lfXf8LIYWrQecKA&s=09" rel="noreferrer">
