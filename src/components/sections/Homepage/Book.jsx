...
const Book = () => {
  return (
    <div className="w-[80%] max-w-screen-xl mx-auto max-md:mx-auto mt-20 mb-20 max-md:mt-20 max-sm:mt-20 flex max-md:flex-col max-sm:flex-col items-center justify-between gap-y-8 max-sm:gap-y-0 max-sm:gap-x-6">
