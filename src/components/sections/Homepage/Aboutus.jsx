        ...
        <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-12 md:grid-cols-2 mt-5 items-start gap-6">
                <div className="lg:col-span-5 mx-auto">
                    ...
                    <h4 className="font-semibold lg:leading-normal leading-normal text-lg lg:text-lg mt-2 mb-5 ">  <RoughNotation type="box" animationDelay={2700} color='blue' animationDuration={2200}  show={true}><span className="text-pink-700">About Tavara</span> </RoughNotation>   </h4>

                    <h4 className="font-semibold lg:leading-normal leading-normal text-xl lg:text-6xl mt-4 mb-5 text-green-700"><RoughNotation type="highlight" animationDelay={7700} color='yellow' animationDuration={4200}  show={true}><span className="text-red-700">Unlimited </span> </RoughNotation>   <RoughNotation type="circle" animationDelay={7700} color='pink' animationDuration={4200}  show={true}><span className="text-pink-700"> Travel </span> </RoughNotation> and Holiday  <RoughNotation type="box" animationDelay={7700} color='blue' animationDuration={4200}  show={true}><span className="text-blue-700">Deals</span> </RoughNotation>   </h4>
                   ...
                   <div className="my-10"> <a href="#" className="bg-red-500 hover:bg-red-600 text-white font-bold py-3 px-10 my-10">Learn More</a></div>
