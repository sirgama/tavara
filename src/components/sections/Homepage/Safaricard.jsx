...
const Safaricard = () => {
 ...
 <div>
       <div class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg transition ease-in-out delay-150  hover:scale-110 ">
    ...
    <div class="mb-3 flex items-center justify-between ">
        ...
        <span class="relative z-10 text-green-500 group-hover:text-white text-sm duration-500">5 Days</span>
      ...
      <p class="block font-sans text-base font-light leading-relaxed text-start text-gray-700 antialiased">
      The Mara Game Reserve
      </p>
      {/* <div class="group mt-8 inline-flex flex-wrap items-center gap-3">
        <span
          data-tooltip-target="money"
          class="cursor-pointer rounded-full border border-red-500/5 bg-red-500/5 p-3 text-red-500 transition-colors hover:border-red-500/10 hover:bg-red-500/10 hover:!opacity-100 group-hover:opacity-70"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
