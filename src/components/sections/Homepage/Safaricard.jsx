...
const Safaricard = ({destination}) => {
 ...
 {destination.map((singlePackage) => {
  ...
  <div key={singlePackage.id} class="relative z-10 flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg transition ease-in-out delay-150  hover:scale-110 ">
