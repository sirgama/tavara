...
const DestinationHighlights = () => {
  return (
    <div>
                <div className="mx-auto max-w-2xl text-center my-8 md:my-28">
                        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Maasai Mara, Kenya</h2>                </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 3H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2h-2M8 3v2m8-2v2M3 9h18M9 14h.01M9 17h.01M12 14h.01M12 17h.01M15 14h.01M15 17h.01" />
            ...
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Duration</p>
        
                 <div class="border-t-2"></div>

                <div class="flex justify-between">
                    <div class="my-2">
                        <p class="font-semibold text-base mb-2">+254 722 000 000</p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M3 14h18" />
            ...
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Tour Guide</p>
        
                 <div class="border-t-2"></div>

                <div class="flex justify-between">
                    <div class="my-2">
                        <p class="font-semibold text-base mb-2">support@tavaratours.com</p>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 4l1 2 1-2" />
            ...
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Cost</p>
        ...
        <div class="relative bg-white py-6 px-6 rounded-3xl w-64 h-40 my-4 shadow-md">
            ...
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Transportation</p>
        
                 <div class="border-t-2"></div>

                <div class="flex justify-between">
                    <div class="my-2">
                        <p class="font-semibold text-base mb-2">www.tavaratours.com</p>
